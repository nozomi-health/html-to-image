        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(isRoot && (options === null || options === void 0 ? void 0 : options.processPdf))) return [3 /*break*/, 2];
                    return [4 /*yield*/, options.processPdf(node)];
                case 1:
                    container = _a.sent();
                    return [2 /*return*/, Promise.resolve(container.cloneNode(true))];
                case 2: return [2 /*return*/, Promise.resolve(node.cloneNode(false))];
            }
        });
    });
}
function cloneCSSStyle(nativeNode, clonedNode, options) {
    ...
    if (source.cssText) {
        ...
        (0, util_1.toArray)(source).forEach(function (name) {
            var originValue = source.getPropertyValue(name);
            var styleValue = originValue;
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, Promise.resolve()
                    .then(function () { return cloneCSSStyle(nativeNode, clonedNode, options); })
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, Promise.resolve(node)
                    ...
                    return cloneSingleNode(clonedNode, options, isRoot);
                })
                    .then(function (clonedNode) {
